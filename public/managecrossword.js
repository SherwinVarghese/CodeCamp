...
if (document.getElementById("waitmessage") != null)
{
	...
	for (var y = 0; y < CrosswordHeight; y++)
	{
		...
		for (var x = 0; x < CrosswordWidth; x++)
		{
			cellValue = "crossword.c" + PadNumber(x) + PadNumber(y);
...
function SelectThisWord(event)
{
	...
	try
	{
		...
		document.getElementById("wordentry").setAttribute("ng-model", "formData.cw"+CurrentWord);
	}
	catch (e)
	{
	}
...
function OKClick()
{
	...
	document.getElementById("cw"+CurrentWord).value = TheirWord;
	DeselectCurrentWord();
	document.getElementById("welcomemessage").style.display = "";
}
